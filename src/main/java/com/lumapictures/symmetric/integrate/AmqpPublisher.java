...
// TODO: Connect to RabbitMQ or whatever
public class AmqpPublisher implements IPublisher, BeanFactoryAware {

    static final Logger log = LoggerFactory.getLogger(AmqpPublisher.class);
